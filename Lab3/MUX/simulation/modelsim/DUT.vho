...
-- Equation(s):
-- \add_instance|f3|Y~0_combout\ = ((\input_vector~combout\(2) & ((\input_vector~combout\(0)))) # (!\input_vector~combout\(2) & (\input_vector~combout\(1))))
...
-- pragma translate_on
PORT MAP (
	datain => \add_instance|f3|Y~0_combout\,
	oe => VCC,
